...
var PageItem;
var editor;
module.exports = PageItem = React.createClass({
    ...
    componentDidUpdate: function () {
        ...
        if(this.state.editMode) {
            editor = new Quill(this.refs.editor.getDOMNode(),{
                modules: {
                    'toolbar': { container: this.refs.toolbar.getDOMNode()},
                    'link-tooltip': true
                }, theme:'snow'});
        }
    ...
    handleEditClick: function (event) {
        ...
        //need to confirm and flag if anything was invalid
    ...
    render: function() {
        var editDisplay 
        if(this.state.editMode) {
            editDisplay = (<form className="pure-form pure-form-stacked">
                <fieldset>
  ...
  <select title="Text Alignment" className="ql-align">
    ...
    <span className="ql-format-group">
      <span title="Link" className="ql-format-button ql-link"></span>
                ...
                <button type="submit" className="pure-button" onClick={this.handleCancelClick}>Cancel</button>
                </fieldset>
                </form>);
        } else {
            editDisplay =(<span className="edit-button" onClick={this.handleClick}>Edit</span>);
         }
        return (
            <li className="page">
